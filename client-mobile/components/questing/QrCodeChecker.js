...
const QrCodeChecker = (props) => {
    ...
    if (userProximity.metres < checkPointGeofence) {
        ...
        message = "congratulations you've found the checkpoint"
    } else {
        console.log ('location co-ordinates are too far away')
        message = "You've either scanned the wrong QR code or are too far away from the checkpoint"
