  ...
  return (
    <>
      <View style={({ ...defaultTheme }, styles.userInfoSection)}>
        <View
          style={({ ...defaultTheme }, { flexDirection: "row", marginTop: 15 })}
        >
          <TouchableOpacity style={{ ...defaultTheme }} onPress={onPress}>
            <Avatar.Image
              source={
          ...
          <View style={({ ...defaultTheme }, { marginLeft: 20 })}>
            ...
            >
              {userData?.username === "" ? user?.email : userData?.username}
            </Title>
            <Caption style={({ ...defaultTheme }, styles.caption)}>
      ...
      <View style={({ ...defaultTheme }, styles.infoBoxWrapper)}>
        ...
        >
          <Title style={{fontWeight: "bold",}}>{userData?.completedQuests?.length}</Title>
        ...
        <View style={({ ...defaultTheme }, styles.infoBox)}>
          ...
          <Text style={styles.caption}>Coins</Text>
        </View>
      </View>
      <View></View>
    </>
